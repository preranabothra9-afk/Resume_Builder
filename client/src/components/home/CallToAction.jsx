...
const CallToAction = () => {
  return (
    <div id='cta' className='relative bg-body px-6 pb-28'>
      <div className="relative max-w-5xl mx-auto overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-600 p-1">
        <div className="relative overflow-hidden rounded-3xl bg-body px-8 py-16 sm:px-16 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center gap-8">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-primary max-w-xl leading-tight">Build a professional resume that helps you stand out and get hired.</h2>
