...
const Footer = () => {
  return (
    <footer className="relative bg-[#08080f] border-t border-white/6 overflow-hidden py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-sm">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-wrap gap-12 lg:gap-20">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" target="_blank" rel="noreferrer" className="p-2.5 rounded-lg bg-white/4 border border-white/6 hover:border-violet-500/30 hover:text-violet-400 hover:bg-violet-500/10 transition-all">
