...
const Banner = () => {
  return (
    <div className="w-full py-2.5 text-sm text-center bg-linear-to-r from-violet-900/80 via-fuchsia-900/60 to-cyan-900/80 border-b border-white/10 relative overflow-hidden">
