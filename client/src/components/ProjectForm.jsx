  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        <p className='text-sm text-white/40'>Add your projects.</p>
      ...
      {data.length === 0 ? (
        <div className='text-center py-10 text-white/20'>
          <FolderIcon className='size-10 mx-auto mb-3 text-white/10' />
          <p className='text-sm font-medium text-white/30'>No projects added</p>
            ...
            <div key={index} className='p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] space-y-3'>
              ...
              <div className='grid gap-3'>
                ...
                <textarea value={project.description || ""} onChange={(e) => updateProject(index, "description", e.target.value)} rows={4}
                  className='w-full resize-none bg-white/[0.02]' placeholder='Describe your project...' />
              </div>
            </div>
          ))}
        </div>
